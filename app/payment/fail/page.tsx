            ...
            <div className="mx-auto max-w-2xl">
                <Card>
                    <CardHeader className="text-center">
                        ...
                        <CardTitle className="font-heading text-3xl">Payment Failed</CardTitle>
                        <CardDescription>
                            The SSLCommerz payment was failed or did not complete. You can retry payment from your rental orders.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
